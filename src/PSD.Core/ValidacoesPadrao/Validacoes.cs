...
namespace PSD.Core.ValidacoesPadrao
{
    public static class Validacoes
    {
        ...
        public static Result TodosDevemSer<T>(this IEnumerable<T> valor, Func<T, bool> condicao, string motivo)
        {
        ...
        public static Result AlgumDeveSer<T>(this IEnumerable<T> valor, Func<T, bool> condicao, string motivo)
        {
        ...
        public static Result AlgumNaoDeveSer<T>(this IEnumerable<T> valor, Func<T, bool> condicao, string motivo)
        {
            return valor.Any(condicao)
                ? Result.Failure(motivo)
                : Result.Success();
        ...
        public static Result EhCompativel(this string valor, string expressao, string motivo)
        {
            if (Regex.IsMatch(valor, expressao))
                return Result.Success();
